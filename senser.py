...
class Sensor:
    ...
    def grab_left(self):
        self.setServoPos(0,3)        # 로봇팔 집게 벌리기
        time.sleep(0.4)

        self.setServoPos(35,2)       # 로봇팔 팔꿈치 펴고 어깨 낮추기 
        self.setServoPos(165,1)
        time.sleep(0.4)

        self.setServoPos(117,3)      # 로봇팔 집게 집기 
        time.sleep(1)

        self.setServoPos(0,2)        # 로봇팔 팔꿈치 접고 어깨 높이기 
        self.setServoPos(70,1)
        time.sleep(0.5)

        self.setServoPos(180,0)        # 어깨 돌리기 (왼쪽으로)
        time.sleep(0.7)

        self.setServoPos(0,2)       # 팔 내리기
        self.setServoPos(140,1)      
        time.sleep(0.5)
    ...
    def grab_right(self):
        ...
        self.setServoPos(35,2)       # 팔 내리기
        self.setServoPos(160,1)      
        time.sleep(0.5)
