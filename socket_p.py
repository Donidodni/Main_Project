...
class socket_p:
    ...
    def robot(self, client_socket, client_address, Message):
        ...
        if result: #result가 비어있지 않으면 
            last_value = result[-1]  # 마지막 값을 가져옴
            ...
            for i in result:
                if "HOME" in i:
                    ...
                    print("yes")
                    self.A_senser.home_pos()
                    self.server_send(client_socket, client_address, "ST/PROC:HOME/END")

                elif "M1_P" in i:
                    print("Move M1 +10")
                    self.modify_value += int(last_value)
                    self.A_senser.setServoPos(self.modify_value, 3)
                    self.server_send(client_socket, client_address, "ST/PROC:M1_P10/END")

                elif "M2_P" in i:
                    print("Move M2 +10")
                    self.modify_value += int(last_value)
                    self.A_senser.setServoPos(self.modify_value, 2)
                    self.server_send(client_socket, client_address, "ST/PROC:M2_P10/END")

                elif "M3_P" in i:
                    print("Move M3 +10")
                    self.modify_value += int(last_value)
                    self.A_senser.setServoPos(self.modify_value, 1)
                    self.server_send(client_socket, client_address, "ST/PROC:M3_P10/END")

                elif "M4_P" in i:
                    print("Move M4 +10")
                    self.modify_value += int(last_value)
                    self.A_senser.setServoPos(self.modify_value, 0)
                    self.server_send(client_socket, client_address, "ST/PROC:M4_P10/END")

                elif "M1_M" in i:
                    print("Move M1 -10")
                    self.modify_value -= int(last_value)
                    self.A_senser.setServoPos(self.modify_value, 3)
                    self.server_send(client_socket, client_address, "ST/PROC:M1_M10/END")

                elif "M2_M" in i:
                    print("Move M2 -10")
                    self.modify_value -= int(last_value)
                    self.A_senser.setServoPos(self.modify_value, 2)
                    self.server_send(client_socket, client_address, "ST/PROC:M2_M10/END")

                elif "M3_M" in i:
                    print("Move M3 -5")
                    self.modify_value -= int(last_value)
                    self.A_senser.setServoPos(self.modify_value, 1)
                    self.server_send(client_socket, client_address, "ST/PROC:M3_M10/END")

                elif "M4_M" in i:
                    print("Move M4 -5")
                    self.modify_value -= int(last_value)
                    self.A_senser.setServoPos(self.modify_value, 0)
                    self.server_send(client_socket, client_address, "ST/PROC:M4_M10/END")
